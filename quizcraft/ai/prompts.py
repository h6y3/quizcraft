...
class PromptTemplate:
    ...
    def construct(self, context: str, **kwargs) -> Dict[str, str]:
        ...
        logger.info(f"Prompt token estimate: {system_tokens + user_tokens} tokens "
...
class QuestionGenerationPrompt(PromptTemplate):
    ...
    def __init__(self):
        ...
        system_prompt = (
            "You are an expert educational content creator who specializes in creating "
            "high-quality multiple-choice questions. Create questions that test both factual "
            "recall and deeper understanding. Each question should be challenging but fair."
        )
